    ...
    try:
        with Image.open(src_path) as img:
            ...
            if dry_run:
                ...
                print(f'  converted  {filename} → {new_filename}  ({before_kb} KB → {after_kb} KB)')
...
if missing_on_disk:
    print(f'  {missing_on_disk} flyer reference(s) point at files not present on disk (left untouched).')
