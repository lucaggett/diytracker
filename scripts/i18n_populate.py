...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "de": {
        ...
        "%(num)d venues with upcoming shows": "%(num)d Venues mit kommenden Shows",
    ...
    "fr": {
        ...
        "%(num)d venues with upcoming shows": "%(num)d salles avec des concerts à venir",
    ...
    "it": {
        ...
        "%(num)d venues with upcoming shows": "%(num)d locali con concerti in programma",
