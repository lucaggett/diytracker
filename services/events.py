...
def compute_event_hash(name, date, doors, genre_str, acts, ticket_link, ticket_price, venue_id):
    ...
    payload = f"{name}{date}{doors}{genre_str}{acts}{ticket_link}{ticket_price}{venue_id}"
